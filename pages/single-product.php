          ...
          <div class="row">
            ...
            <div class="col-md-12 mt-2">
              ...
              <div thumbsslider="" class="swiper product-thumbnail-slider swiper-initialized swiper-horizontal swiper-free-mode swiper-watch-progress swiper-backface-hidden swiper-thumbs">
                <div class="swiper-wrapper" id="swiper-wrapper-ba702457cd9b4469" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
          ...
          <div class="product-info">
            ...
            <div class="meta-product pt-4">
              <div class="meta-item d-flex align-items-baseline">
                <h6 class="item-title fw-bold no-margin pe-2" data-sider-select-id="d2b4a286-6ab5-454a-89af-894e30e16fc8">SKU:</h6>
                <ul class="select-list list-unstyled d-flex">
                  <li data-value="S" class="select-item">1223</li>
                </ul>
              </div>
              <div class="meta-item d-flex align-items-baseline">
                <h6 class="item-title fw-bold no-margin pe-2" data-sider-select-id="0a9ffc45-01a7-4ff6-adf6-4a60956e241a">Category:</h6>
                <ul class="select-list list-unstyled d-flex">
              ...
              <div class="meta-item d-flex align-items-baseline">
                <h6 class="item-title fw-bold no-margin pe-2" data-sider-select-id="05e6af0a-bd51-4da0-ac4e-f2a89775a2f2">Tags:</h6>
                <ul class="select-list list-unstyled d-flex">
                  <li data-value="S" class="select-item">
                    <a href="#">Clothes</a>,
                  </li>
